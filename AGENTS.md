# FitAgent — Codex Instructions

## What We Are Building
A PWA fitness coaching agent powered by Codex AI. 
...
- Codex does all fitness reasoning. The app manages 
...
- React (Vite)
- TailwindCSS
- Codex API (Haiku for simple, Sonnet for complex)
...
- No hardcoded fitness logic — Codex reasons 
